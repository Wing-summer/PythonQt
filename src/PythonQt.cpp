...
void PythonQt::init(int flags, const QByteArray &pythonQtModuleName) {
  if (!_self) {
    ...
    _self->_p->_PythonQtObjectPtr_metaId =
        qRegisterMetaType<PythonQtObjectPtr>("PythonQtObjectPtr");
    ...
    PythonQtConv::registerMetaTypeToPythonConverter(
        stringRefId, PythonQtConv::convertFromStringRef);

    int objectPtrListId =
        qRegisterMetaType<QList<PythonQtObjectPtr>>("QList<PythonQtObjectPtr>");
    PythonQtConv::registerMetaTypeToPythonConverter(
        objectPtrListId, PythonQtConv::convertFromQListOfPythonQtObjectPtr);
    PythonQtConv::registerPythonToMetaTypeConverter(
        objectPtrListId, PythonQtConv::convertToQListOfPythonQtObjectPtr);
    ...
    PythonQtMethodInfo::addParameterTypeAlias("QVector<MLfloat>",
                                              "QVector<float>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<MLdouble>",
                                              "QList<double>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<MLdouble>",
                                              "QVector<double>");

    PythonQtMethodInfo::addParameterTypeAlias("QList<MLuint32>",
                                              "QList<quint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<MLuint32>",
                                              "QVector<quint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<MLint32>",
                                              "QList<qint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<MLint32>",
                                              "QVector<qint32>");

    PythonQtMethodInfo::addParameterTypeAlias("QList<MLuint64>",
                                              "QList<quint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<MLuint64>",
                                              "QVector<quint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<MLint64>",
                                              "QList<qint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<MLint64>",
                                              "QVector<qint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<MLuint>",
                                              "QList<quint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<MLuint>",
                                              "QVector<quint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<MLint>", "QList<qint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<MLint>",
                                              "QVector<qint64>");
#endif

    PythonQtMethodInfo::addParameterTypeAlias("QList<qreal>", "QList<double>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<qreal>",
                                              "QVector<double>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<unsigned int>",
                                              "QList<quint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<unsigned int>",
                                              "QVector<quint32>");
    ...
    PythonQtMethodInfo::addParameterTypeAlias("QVector<uint>",
                                              "QVector<quint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<int>", "QList<qint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<int>",
                                              "QVector<qint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<GLint>", "QList<qint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<GLint>",
                                              "QVector<qint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<GLuint>", "QList<qint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<GLuint>",
                                              "QVector<quint32>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<GLuint64>",
                                              "QList<quint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<GLuint64>",
                                              "QVector<quint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<GLint64>",
                                              "QList<qint64>");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<GLint64>",
                                              "QVector<qint64>");

    PythonQtMethodInfo::addParameterTypeAlias("QList<QLocale::Country>",
                                              "QList<int>");
    PythonQtMethodInfo::addParameterTypeAlias("QList<Qt::DayOfWeek>",
                                              "QList<int>");
    ...
    PythonQtMethodInfo::addParameterTypeAlias("QPair<qreal,qreal>",
                                              "QPair<double,double>");
    PythonQtMethodInfo::addParameterTypeAlias("QPair<qreal,QColor>",
                                              "QPair<double,QColor>");
    PythonQtMethodInfo::addParameterTypeAlias("QPair<qreal,QPointF>",
                                              "QPair<double,QPointF>");
    PythonQtMethodInfo::addParameterTypeAlias("QPair<qreal,QVariant>",
                                              "QPair<double,QVariant>");
    PythonQtMethodInfo::addParameterTypeAlias(
    ...
    PythonQtMethodInfo::addParameterTypeAlias(
        "QVector<QPair<qreal,QVariant> >", "QVector<QPair<double,QVariant> >");
    PythonQtMethodInfo::addParameterTypeAlias("QVector<QPair<qreal,QColor> >",
    ...
    // NOTE: the extra space between the > is needed (and added by the moc)
    PythonQtMethodInfo::addParameterTypeAlias("QList<QPair<qreal,QPointF> >",
                                              "QList<QPair<double,QPointF> >");
    PythonQtMethodInfo::addParameterTypeAlias("QList<QPair<qreal,qreal> >",
    ...
    PythonQtMethodInfo::addParameterTypeAlias(
        "QHash<QNetworkRequest::Attribute,QVariant>", "QHash<int,QVariant>");
    ...
    PyObject *qtNamespace =
        PythonQt::priv()->getClassInfo("Qt")->pythonQtClassWrapper();
    const char *names[16] = {
        "SIGNAL",        "SLOT",     "qAbs",      "qBound",
        "qDebug",        "qWarning", "qCritical", "qFatal",
        "qFuzzyCompare", "qMax",     "qMin",      "qRound",
        "qRound64",      "qVersion", "qrand",     "qsrand"};
    ...
    int enumValues[] = {QtDebugMsg, QtWarningMsg, QtCriticalMsg, QtFatalMsg,
                        QtSystemMsg};
    const char *enumNames[] = {"QtDebugMsg", "QtWarningMsg", "QtCriticalMsg",
    ...
    _self->priv()->pythonQtModule().addObject("Debug",
                                              _self->priv()->_debugAPI);

    PyModule_AddObject(pack, "Slot", (PyObject *)&PythonQtSlotDecorator_Type);
    PyModule_AddObject(pack, "Signal",
                       (PyObject *)&PythonQtSignalFunction_Type);
...
PythonQt::PythonQt(int flags, const QByteArray &pythonQtModuleName) {
  ...
  if (PyType_Ready(&PythonQtBoolResult_Type) < 0) {
    std::cerr << "could not initialize PythonQtBoolResult_Type"
              << ", in " << __FILE__ << ":" << __LINE__ << std::endl;
  }
  Py_INCREF(&PythonQtBoolResult_Type);

  // according to Python docs, set the type late here, since it can not safely
  // be stored in the struct when declaring it
  ...
  if (PyType_Ready(&PythonQtInstanceWrapper_Type) < 0) {
    ...
    std::cerr << "could not initialize PythonQtInstanceWrapper_Type"
              << ", in " << __FILE__ << ":" << __LINE__ << std::endl;
  }
  ...
  if (PyType_Ready(&PythonQtStdOutRedirectType) < 0) {
    std::cerr << "could not initialize PythonQtStdOutRedirectType"
              << ", in " << __FILE__ << ":" << __LINE__ << std::endl;
  }
  ...
  if (PyType_Ready(&PythonQtStdInRedirectType) < 0) {
    std::cerr << "could not initialize PythonQtStdInRedirectType"
              << ", in " << __FILE__ << ":" << __LINE__ << std::endl;
  }
...
void PythonQt::setRedirectStdInCallback(PythonQtInputChangedCB *callback,
  ...
  if (!callback) {
    std::cerr
        << "PythonQt::setRedirectStdInCallback - callback parameter is NULL !"
        << std::endl;
    return;
  }
  ...
  if (!PyObject_HasAttrString(sys.object(), "pythonqt_original_stdin")) {
    PyObject_SetAttrString(sys.object(), "pythonqt_original_stdin",
                           PyObject_GetAttrString(sys.object(), "stdin"));
  }
  ...
  if (enabled) {
    if (!PyObject_HasAttrString(sys.object(), "pythonqt_stdin")) {
      PyObject_SetAttrString(
          sys.object(), "stdin",
          PyObject_GetAttrString(sys.object(), "pythonqt_stdin"));
    }
  } else {
    if (!PyObject_HasAttrString(sys.object(), "pythonqt_original_stdin")) {
      PyObject_SetAttrString(
          sys.object(), "stdin",
          PyObject_GetAttrString(sys.object(), "pythonqt_original_stdin"));
    }
  }
}

PythonQtImportFileInterface *PythonQt::importInterface() {
  return _self->_p->_importInterface ? _self->_p->_importInterface
                                     : _self->_p->_defaultImporter;
}
...
void PythonQt::registerClass(const QMetaObject *metaobject, const char *package,
                             ...
                             PythonQtShellSetInstanceWrapperCB *shell) {
  _p->registerClass(metaobject, package, wrapperCreator, shell);
}

void PythonQtPrivate::registerClass(
    const QMetaObject *metaobject, const char *package,
    PythonQtQObjectCreatorFunctionCB *wrapperCreator,
    PythonQtShellSetInstanceWrapperCB *shell, PyObject *module, int typeSlots) {
  // we register all classes in the hierarchy
  const QMetaObject *m = metaobject;
  bool first = true;
  while (m) {
    PythonQtClassInfo *info =
        lookupClassInfoAndCreateIfNotPresent(m->className());
    if (!info->pythonQtClassWrapper()) {
      info->setTypeSlots(typeSlots);
      info->setupQObject(m);
      createPythonQtClassWrapper(info, package, module);
      if (m->superClass()) {
        PythonQtClassInfo *parentInfo =
            lookupClassInfoAndCreateIfNotPresent(m->superClass()->className());
        info->addParentClass(PythonQtClassInfo::ParentClassInfo(parentInfo));
      }
    } else if (first && module) {
      // There is a wrapper already, but if we got a module, we want to place
      // the wrapper into that module as well, since it might have been placed
      // into "private" earlier on. If the wrapper was already added to module
      // before, it is just readded, which does no harm.
...
void PythonQtPrivate::createPythonQtClassWrapper(PythonQtClassInfo *info,
                                                 const char *package,
                                                 PyObject *module) {
  ...
  PyObject *pyobj =
      (PyObject *)createNewPythonQtClassWrapper(info, pack, pythonClassName);

  if (isNested) {
    QByteArray outerClass =
        QByteArray(info->className()).mid(0, nestedClassIndex);
    PythonQtClassInfo *outerClassInfo =
        lookupClassInfoAndCreateIfNotPresent(outerClass);
    outerClassInfo->addNestedClass(info);
  } else {
    PyModule_AddObject(pack, info->className(), pyobj);
  }
  if (!module && package && strncmp(package, "Qt", 2) == 0) {
    // since PyModule_AddObject steals the reference, we need a incref once
    // more...
    Py_INCREF(pyobj);
...
PyObject *PythonQtPrivate::wrapQObject(QObject *obj) {
  ...
  if (!wrap) {
    ...
    PythonQtClassInfo *classInfo =
        _knownClassInfos.value(obj->metaObject()->className());
    ...
    //    mlabDebugConst("MLABPython","new qobject wrapper added " << " " <<
    //    wrap->_obj->className() << " " <<
    //    wrap->classInfo()->wrappedClassName().latin1());
  } else {
    Py_INCREF(wrap);
    //    mlabDebugConst("MLABPython","qobject wrapper reused " <<
    //    wrap->_obj->className() << " " <<
    //    wrap->classInfo()->wrappedClassName().latin1());
  }
...
PyObject *PythonQtPrivate::wrapPtr(void *ptr, const QByteArray &name,
  ...
  if (wrap && wrap->_wrappedPtr) {
    ...
    // we are not sure if it may have been deleted earlier and we just see the
    // same C++ pointer once again. To make sure that we do not reuse a wrapper
    // of the wrong type, we compare the classInfo() pointer and only reuse the
    // wrapper if it has the same info. This is only needed for non-QObjects,
    // since we know it when a QObject gets deleted.
  ...
  if (!wrap) {
    ...
    if (!info) {
      ...
      if (name == "PyObject") {
        // do not increment its ref-count, it is the job of the slot returning
        // the value to ensure an extra ref on return.
        return (PyObject *)ptr;
      }
    ...
    if (info && info->isQObject()) {
      QObject *qptr = (QObject *)ptr;
      // if the object is a derived object, we want to switch the class info to
      // the one of the derived class:
    ...
    if (info) {
      // try to downcast in the class hierarchy, which will modify info and ptr
      ...
      if (info && info->isQObject()) {
        QObject *qptr = (QObject *)ptr;
        // if the object is a derived object, we want to switch the class info
        // to the one of the derived class:
        if (name != (qptr->metaObject()->className())) {
          registerClass(qptr->metaObject());
          info = _knownClassInfos.value(qptr->metaObject()->className());
        }
    ...
    if (wrapper && (info->metaObject() != wrapper->metaObject())) {
      // if we a have a QObject wrapper and the metaobjects do not match, set
      // the metaobject again!
      info->setMetaObject(wrapper->metaObject());
    }

    if (possibleStillAliveWrapper &&
        possibleStillAliveWrapper->classInfo()->inherits(info)) {
    ...
    //          mlabDebugConst("MLABPython","new c++ wrapper added " <<
    //          wrap->_wrappedPtr << " " << wrap->_obj->className() << " " <<
    //          wrap->classInfo()->wrappedClassName().latin1());
  } else {
    Py_INCREF(wrap);
    // mlabDebugConst("MLABPython","c++ wrapper reused " << wrap->_wrappedPtr <<
    // " " << wrap->_obj->className() << " " <<
    // wrap->classInfo()->wrappedClassName().latin1());
  }
  return (PyObject *)wrap;
...
PythonQtInstanceWrapper *PythonQtPrivate::createNewPythonQtInstanceWrapper(
    QObject *obj, PythonQtClassInfo *info, void *wrappedPtr) {
  // call the associated class type to create a new instance...
  PythonQtInstanceWrapper *result = (PythonQtInstanceWrapper *)PyObject_Call(
      info->pythonQtClassWrapper(), dummyTuple(), NULL);
  ...
  if (wrappedPtr || obj) {
    ...
    if (wrappedPtr) {
      ...
      if (obj->parent() == NULL && _wrappedCB) {
        // tell someone who is interested that the qobject is wrapped the first
        // time, if it has no parent
        (*_wrappedCB)(obj);
      }
    }
  }
...
PythonQtClassWrapper *PythonQtPrivate::createNewPythonQtClassWrapper(
    PythonQtClassInfo *info, PyObject *parentModule,
  ...
  result = (PythonQtClassWrapper *)PyObject_Call(
      (PyObject *)&PythonQtClassWrapper_Type, args, NULL);
...
PyObject *PythonQtPrivate::createEnumValueInstance(PyObject *enumType,
...
PyObject *
PythonQtPrivate::createNewPythonQtEnumWrapper(const char *enumName,
...
bool PythonQt::addSignalHandler(QObject *obj, const char *signal,
                                PyObject *module, const QString &objectname) {
  bool flag = false;
...
bool PythonQt::removeSignalHandler(QObject *obj, const char *signal,
                                   PyObject *module,
...
PythonQtObjectPtr PythonQt::lookupCallable(PyObject *module,
                                           const QString &name) {
    ...
    if (PyModule_Check(object)) {
      ...
      globals = PyObject_GetAttrString(
          PyImport_ImportModule(
              PyString_AS_STRING(PyObject_GetAttrString(object, "__module__"))),
          "__dict__");
    }
    PyObject *r = NULL;
    if (dict) {
...
QVariant PythonQt::evalScript(PyObject *object, const QString &script,
                              int start) {
  QVariant result;
  PythonQtObjectPtr p;
  PyObject *dict = NULL;
...
PythonQtObjectPtr PythonQt::createModuleFromScript(const QString &name,
  ...
  pycode.setNewRef(Py_CompileString((char *)scriptCode.toLatin1().data(), "",
                                    Py_file_input));
...
void PythonQt::addObject(PyObject *object, const QString &name,
                         QObject *qObject) {
  if (PyModule_Check(object)) {
    PyModule_AddObject(object, name.toLatin1().data(),
                       _p->wrapQObject(qObject));
  } else if (PyDict_Check(object)) {
    PyDict_SetItemString(object, name.toLatin1().data(),
                         _p->wrapQObject(qObject));
  } else {
    PyObject_SetAttrString(object, name.toLatin1().data(),
                           _p->wrapQObject(qObject));
  }
}

void PythonQt::addVariable(PyObject *object, const QString &name,
                           const QVariant &v) {
  if (PyModule_Check(object)) {
    PyModule_AddObject(object, name.toLatin1().data(),
                       PythonQtConv::QVariantToPyObject(v));
  } else if (PyDict_Check(object)) {
    PyDict_SetItemString(object, name.toLatin1().data(),
                         PythonQtConv::QVariantToPyObject(v));
  } else {
...
QStringList PythonQt::introspection(PyObject *module, const QString &objectname,
                                    PythonQt::ObjectType type) {
  QStringList results;
      ...
      for (int i = 0; i < count; i++) {
        ...
        if (!keystr.startsWith(underscoreStr)) {
          ...
          case Module:
            ...
            break;
          default:
            std::cerr << "PythonQt: introspection: unknown case"
                      << ", in " << __FILE__ << ":" << __LINE__ << std::endl;
          }
        }
        Py_DECREF(value);
...
PyObject *PythonQt::getObjectByType(const QString &typeName) {
  ...
  PyObject *moduleObject =
      PyDict_GetItemString(modules, moduleName.toLatin1().constData());
  if (moduleObject) {
    object = PyObject_GetAttrString(moduleObject,
                                    simpleTypeName.toLatin1().constData());
  }
...
QStringList PythonQt::introspectType(const QString &typeName, ObjectType type) {
  ...
  if (!object) {
    ...
    if (typeObject) {
      object =
          PyObject_GetAttrString(typeObject, memberName.toLatin1().constData());
    }
  }
  if (object) {
    results = introspectObject(object, type);
...
QVariant PythonQt::call(PyObject *object, const QString &name,
...
PyObject *PythonQt::callAndReturnPyObject(PyObject *callable,
  ...
  if (callable) {
    ...
    int count = args.size();
    if ((count > 0) ||
        (kwargs.count() > 0)) { // create empty tuple if kwargs are given
...
void PythonQt::addClassDecorators(QObject *o) {
  _p->addDecorators(o, PythonQtPrivate::StaticDecorator |
                           PythonQtPrivate::ConstructorDecorator |
                           PythonQtPrivate::DestructorDecorator);
}
...
#ifdef __linux
#ifdef _DEBUG
  // First look for shared libraries with the '_d' suffix in debug mode on
  // Linux. This is a workaround, because python does not append the '_d' suffix
  // on Linux and would always load the release library otherwise.
    ...
    if ((m.methodType() == QMetaMethod::Method ||
      ...
      if (signature.startsWith("new_")) {
        if ((decoTypes & ConstructorDecorator) == 0)
          continue;
        const PythonQtMethodInfo *info =
            PythonQtMethodInfo::getCachedMethodInfo(m, NULL);
        if (info->parameters().at(0).pointerCount == 1) {
          QByteArray nameOfClass = signature.mid(4);
          nameOfClass.replace("__", "::");
          PythonQtClassInfo *classInfo =
              lookupClassInfoAndCreateIfNotPresent(nameOfClass);
          PythonQtSlotInfo *newSlot = new PythonQtSlotInfo(
              NULL, m, i, o, PythonQtSlotInfo::ClassDecorator);
        ...
        if (info->parameters().count() > 1) {
          ...
          if (p.pointerCount == 1) {
            PythonQtClassInfo *classInfo =
                lookupClassInfoAndCreateIfNotPresent(p.name);
            PythonQtSlotInfo *newSlot = new PythonQtSlotInfo(
                NULL, m, i, o, PythonQtSlotInfo::InstanceDecorator);
            classInfo->addDecoratorSlot(newSlot);
          }
        }
      }
...
void PythonQt::removeSignalHandlers() {
  QList<PythonQtSignalReceiver *> signalReceivers =
      _p->_signalReceivers.values();

  // just delete all signal receivers, they will remove themselves via
  // removeSignalEmitter()
...
bool PythonQt::handleError() {
  ...
  if (PyErr_Occurred()) {
    ...
    if (_p->_systemExitExceptionHandlerEnabled &&
      ...
      // currently we just print the error and the stderr handler parses the
      // errors
      PyErr_Print();

      /*
      // EXTRA: the format of the ptype and ptraceback is not really documented,
      so I use PyErr_Print() above PyObject *ptype; PyObject *pvalue; PyObject
      *ptraceback; PyErr_Fetch( &ptype, &pvalue, &ptraceback);
...
bool PythonQt::hadError() const { return _p->_hadError; }

void PythonQt::clearError() { _p->_hadError = false; }
...
void PythonQt::overwriteSysPath(const QStringList &paths) {
  ...
  PyModule_AddObject(sys, "path",
                     PythonQtConv::QStringListToPyList(nativePaths));
}

void PythonQt::setModuleImportPath(PyObject *module, const QStringList &paths) {
  PyModule_AddObject(module, "__path__",
                     PythonQtConv::QStringListToPyList(paths));
}
...
void PythonQt::setQObjectNoLongerWrappedCallback(
    PythonQtQObjectNoLongerWrappedCB *cb) {
  _p->_noLongerWrappedCB = cb;
}

void PythonQt::setProfilingCallback(ProfilingCB *cb) { _p->_profilingCB = cb; }

static PyMethodDef PythonQtMethods[] = {{NULL, NULL, 0, NULL}};

#ifdef PY3K
static PyModuleDef PythonQtModuleDef = {PyModuleDef_HEAD_INIT,
                                        "",
                                        NULL,
                                        -1,
                                        PythonQtMethods,
...
void PythonQt::initPythonQtModule(bool redirectStdOut,
  ...
  PyModule_AddObject(_p->pythonQtModule().object(), "BoolResult",
                     (PyObject *)&PythonQtBoolResult_Type);
  PythonQtObjectPtr sys;
  sys.setNewRef(PyImport_ImportModule("sys"));
  ...
  if (redirectStdOut) {
    ...
    out = PythonQtStdOutRedirectType.tp_new(&PythonQtStdOutRedirectType, NULL,
                                            NULL);
    ((PythonQtStdOutRedirect *)out.object())->_cb = stdOutRedirectCB;
    err = PythonQtStdOutRedirectType.tp_new(&PythonQtStdOutRedirectType, NULL,
                                            NULL);
  ...
  PyDict_SetItem(PyObject_GetAttrString(sys.object(), "modules"),
                 PyUnicode_FromString(name.constData()),
                 _p->_pythonQtModule.object());
#endif
}
...
QString PythonQt::getReturnTypeOfWrappedMethod(const QString &typeName,
  ...
  return getReturnTypeOfWrappedMethodHelper(typeObject, methodName,
                                            typeName + "." + methodName);
}

QString PythonQt::getReturnTypeOfWrappedMethodHelper(
    const PythonQtObjectPtr &variableObject, const QString &methodName,
    const QString &context) {
  PythonQtObjectPtr methodObject;
  if (PyDict_Check(variableObject)) {
    methodObject =
        PyDict_GetItemString(variableObject, methodName.toLatin1().constData());
  } else {
    methodObject.setNewRef(PyObject_GetAttrString(
        variableObject, methodName.toLatin1().constData()));
  }
  ...
  if (PythonQtUtils::isPythonClassType(methodObject)) {
    // the methodObject is not a method, but the name of a type/class. This
    // means a constructor is called. Return the context.
    type = context;
  } else if (methodObject->ob_type == &PythonQtSlotFunction_Type) {
    PythonQtSlotInfo *slotInfo =
        ((PythonQtSlotFunctionObject *)methodObject.object())->m_ml;
    if (slotInfo) {
      if (slotInfo->parameterCount() > 0) {
        ...
        if (!type.isEmpty()) {
          // if the type is a known class info, then create the full type name,
          // i.e. include the module name. For example, the slot may return a
          // QDate, then this looks up the name _PythonQt.QtCore.QDate.
          PythonQtClassInfo *typeInfo =
              _p->_knownClassInfos.value(type.toLatin1().constData());
          if (typeInfo && typeInfo->pythonQtClassWrapper()) {
            PyObject *s = PyObject_GetAttrString(
                typeInfo->pythonQtClassWrapper(), "__module__");
...
void PythonQt::registerCPPClass(
    const char *typeName, const char *parentTypeName, const char *package,
    PythonQtQObjectCreatorFunctionCB *wrapperCreator,
    PythonQtShellSetInstanceWrapperCB *shell) {
...
PythonQtClassInfo *
PythonQtPrivate::lookupClassInfoAndCreateIfNotPresent(const char *typeName) {
...
bool PythonQt::addParentClass(const char *typeName, const char *parentTypeName,
                              int upcastingOffset) {
...
bool PythonQtPrivate::addParentClass(const char *typeName,
  ...
  if (info) {
    PythonQtClassInfo *parentInfo =
        lookupClassInfoAndCreateIfNotPresent(parentTypeName);
    info->addParentClass(
        PythonQtClassInfo::ParentClassInfo(parentInfo, upcastingOffset));
    return true;
  } else {
    return false;
  }
...
void PythonQtPrivate::registerCPPClass(
    const char *typeName, const char *parentTypeName, const char *package,
    PythonQtQObjectCreatorFunctionCB *wrapperCreator,
    PythonQtShellSetInstanceWrapperCB *shell, PyObject *module, int typeSlots) {
  PythonQtClassInfo *info = lookupClassInfoAndCreateIfNotPresent(typeName);
...
void PythonQtPrivate::handleVirtualOverloadReturnError(
    const char *signature, const PythonQtMethodInfo *methodInfo,
    PyObject *result) {
  QString error = "Return value '" + PythonQtConv::PyObjGetString(result) +
                  "' can not be converted to expected C++ type '" +
                  methodInfo->parameters().at(0).name +
...
PythonQtPrivate::findWrapperAndRemoveUnused(void *obj) {
...
PythonQtObjectPtr PythonQtPrivate::createModule(const QString &name,
  ...
  if (pycode) {
    result.setNewRef(
        PyImport_ExecCodeModule((char *)name.toLatin1().data(), pycode));
  } else {
    PythonQt::self()->handleError();
  }
  return result;
...
bool PythonQtPrivate::isMethodDescriptor(PyObject *object) const {
  // This implementation is the same as in inspect.ismethoddescriptor(),
  // inspect.py.
  if (PyObject_HasAttrString(object, "__get__") &&
      !PyObject_HasAttrString(object, "__set__") && !PyMethod_Check(object) &&
...
const QMetaObject *
PythonQtPrivate::getDynamicMetaObject(PythonQtInstanceWrapper *wrapper,
                                      const QMetaObject *prototypeMetaObject) {
  PythonQtDynamicClassInfo *info = wrapper->dynamicClassInfo();
  if (info) {
    if (!info->_dynamicMetaObject) {
      setupDynamicMetaObjectChain(((PythonQtClassWrapper *)Py_TYPE(wrapper)),
                                  prototypeMetaObject);
    }
...
const QMetaObject *PythonQtPrivate::setupDynamicMetaObjectChain(
    PythonQtClassWrapper *type, const QMetaObject *prototypeMetaObject) {
  if (!type->_dynamicClassInfo->_dynamicMetaObject) {
    ...
    if (((PythonQtClassWrapper *)superType)->_dynamicClassInfo) {
      metaObjectOfParent = setupDynamicMetaObjectChain(
          (PythonQtClassWrapper *)superType, prototypeMetaObject);
    }
...
const QMetaObject *PythonQtPrivate::buildDynamicMetaObject(
    PythonQtClassWrapper *type, const QMetaObject *prototypeMetaObject) {
  // std::cout << "creating " << ((PyTypeObject*)type)->tp_name << " derived
  // from " << prototypeMetaObject->className() << std::endl;
  ...
  while (PyDict_Next(dict, &pos, &key, &value)) {
    if (PythonQtSignalFunction_Check(value)) {
      ...
      PythonQtSignalFunctionObject *signal =
          (PythonQtSignalFunctionObject *)value;
  ...
  value = NULL;
  key = NULL;
  // Now look for slots: (this is a bug in QMetaObjectBuilder, all signals need
  // to be added first)
  while (PyDict_Next(dict, &pos, &key, &value)) {
    if (PythonQtProperty_Check(value)) {
      needsMetaObject = true;
      PythonQtProperty *prop = (PythonQtProperty *)value;
      QMetaPropertyBuilder newProp =
          builder.addProperty(PyString_AsString(key), prop->data->cppType);
      ...
      if (prop->data->notify) {
        PythonQtSignalFunctionObject *signal =
            (PythonQtSignalFunctionObject *)prop->data->notify;
        if (signal->_dynamicInfo) {
          ...
          if (idx != -1) {
            ...
            std::cerr << "could not find notify signal signature "
                      << fullSig.constData();
          }
        }
      }
    ...
    if (PyFunction_Check(value) && PyObject_HasAttr(value, qtSlots)) {
      // A function which has a "_qtSlots" signature list, add the slots to the
      // meta object
  ...
  if (needsMetaObject) {
    ...
    type->_dynamicClassInfo->_classInfo->setupQObject(
        type->_dynamicClassInfo->_dynamicMetaObject);
  } else {
...
int PythonQtPrivate::handleMetaCall(QObject *object,
  ...
  if (call == QMetaObject::InvokeMetaMethod) {
    ...
    // Get directly from the Python class, since we don't want to get the value
    // of the property
    PyObject *maybeProp = PyBaseObject_Type.tp_getattro(
        (PyObject *)wrapper, PyString_FromString(metaProp.name()));
    ...
    if (call == QMetaObject::WriteProperty) {
      ...
      if (value) {
        void *result =
            PythonQtConv::ConvertPythonToQt(info, value, false, NULL, args[0]);
        Py_DECREF(value);
...
void PythonQtPrivate::callMethodInPython(QMetaMethod &method,
  ...
  if (func) {
    const PythonQtMethodInfo *methodInfo =
        PythonQtMethodInfo::getCachedMethodInfo(method, NULL);
    PyObject *result =
        PythonQtSignalTarget::call(func, methodInfo, args, false);
    if (result) {
      PythonQtConv::ConvertPythonToQt(methodInfo->parameters().at(0), result,
                                      false, NULL, args[0]);
      // TODO: handle error?
      // PythonQt::priv()->handleVirtualOverloadReturnError("devType",
      // methodInfo, result);
    }
    Py_XDECREF(result);
    Py_DECREF(func);
...
QString PythonQtPrivate::getSignature(PyObject *object) {
  ...
  if (object) {
    ...
    if (func) {
      ...
      //       inspect.getargs() can handle anonymous (tuple) arguments, while
      //       this code does not. It can be implemented, but it may be rarely
...
PyObject *PythonQtPrivate::wrapMemoryAsBuffer(const void *data,
                                              Py_ssize_t size) {
#ifdef PY3K
  ...
  if (!result) {
    ...
    if (!recursion) {
      if (_knownLazyClasses.contains(className)) {
        ...
        if (!result) {
          std::cerr << "PythonQt lazy import " << module.constData()
                    << " did not resolve " << className.constData()
                    << std::endl;
        }
      }
    }
